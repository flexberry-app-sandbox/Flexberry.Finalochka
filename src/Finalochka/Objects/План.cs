...
namespace IIS.Finalochka
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalochka.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Finalochka.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Finalochka.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Finalochka.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Finalochka.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Finalochka.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Finalochka.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Finalochka.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Finalochka.План this[int index]
        {
            get
            {
                return ((IIS.Finalochka.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Finalochka.План dataobject)
        {
