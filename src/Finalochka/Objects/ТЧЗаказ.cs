...
namespace IIS.Finalochka
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalochka.ЕдиницыИзмер fЕдиницыИзмер;
        
        private IIS.Finalochka.Номенклатура fНоменклатура;
        
        private IIS.Finalochka.ЗаказПост fЗаказПост;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.Finalochka.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Finalochka.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Finalochka.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Finalochka.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Finalochka.ЗаказПост.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ЗаказПост"})]
        public virtual IIS.Finalochka.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.Finalochka.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Finalochka.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Finalochka.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Finalochka.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Finalochka.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.Finalochka.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Finalochka.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Finalochka.ТЧЗаказ dataobject)
        {
