...
namespace IIS.Finalochka
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalochka.DetailArrayOfПлан fПлан;
        ...
        public virtual IIS.Finalochka.DetailArrayOfПлан План
        {
            get
            {
                ...
                if ((this.fПлан == null))
                {
                    this.fПлан = new IIS.Finalochka.DetailArrayOfПлан(this);
                }
                IIS.Finalochka.DetailArrayOfПлан result = this.fПлан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.Finalochka.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.Finalochka.ПланЗакупок));
                }
            }
        }
    }
