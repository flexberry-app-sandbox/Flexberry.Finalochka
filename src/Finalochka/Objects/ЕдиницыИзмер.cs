    ...
    public class ЕдиницыИзмер : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмерE", typeof(IIS.Finalochka.ЕдиницыИзмер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмерL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмерL", typeof(IIS.Finalochka.ЕдиницыИзмер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмеренияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмеренияE", typeof(IIS.Finalochka.ЕдиницыИзмер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмеренияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмеренияL", typeof(IIS.Finalochka.ЕдиницыИзмер));
                }
            }
        }
    }
